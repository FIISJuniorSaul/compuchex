                ...
                <div class="card">
                        <div class="header bg-cyan">
                            ...
                            <div class="body table-responsive">
                                    <table class="table table-responsive table-striped">
                                        <thead>
                                            <th>Inicio de Inasistencia</th>
                                            <th>Fin de Inasistencia</th>
                                            <th>Observaciones</th>
                                            <th>Justificada</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Desde : {{$ausencia->inicio_ausencia}}</td>
                                                  
                                                 <td> Hasta : {{$ausencia->finalizacion_ausencia}}
