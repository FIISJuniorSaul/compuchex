  ...
  <div class="body">
    ...
    <div class="form-group">   
              <div class="col-md-4">
                ...
                <input type="text" class="datepicker form-control " name="fecha_inicio" placeholder="Clic aquí para seleccionar fecha...">
              </div>
              ...
              <div class="col-md-4">
                  ...
                  <input type="text" class="datepicker form-control " name="fecha_finalizacion" placeholder="Clic aquí para seleccionar fecha...">
              </div>

              
                    <div class="col-md-4">
                        <label for="dias_habiles_ausencia">Dias hábiles de ausencia</label>

                        <input type="text"  class="form-control " name="dias_habiles_ausencia" placeholder="Dias habiles" >
                    </div>
